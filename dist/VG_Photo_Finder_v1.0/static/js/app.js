document.addEventListener('DOMContentLoaded', () => {
  ...
  // Safety check
  if (!modal || !modalFilename || !modalPath) {
    console.error('Modal elements missing!', { modal, modalFilename, modalPath });
  }
  ...
  function updateModalContent() {
    ...
    if (modalPath) modalPath.textContent = it.folder;
    if (downloadBtn) downloadBtn.href = `/download/${it.id}`;
  }
